...
car = robinzon_problem.RobinzonProblem(RANDOM_SEED)
...
# create an operator that randomly returns 0..17:
toolbox.register("zeroOneOrTwo", random.randint, 0, 17)
